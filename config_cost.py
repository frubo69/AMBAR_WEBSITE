...
С 22 сентября 2026 (владелец: «возьми самые низкие цены — в закупке у нас
или в их чеках») здесь меньшая из двух: цена листа или цена, по которой
магазин реально отпускал нам в 23 счетах с 16.08 по 12.09. Где их счёт был
дешевле листа, строка помечена «по их счёту» и рядом прежняя цена листа — 26
позиций. Там, где лист дешевле их счетов (Absolut 34.65 при 35 в счетах,
Corona 85.05 при 142), оставлен лист. Эти же цены стоят в заявке магазину
(колонка Price).
...
COST = {
    ...
    "p32":  89,      # Heineken 0.33 bottle — по их счёту; в листе было 99.75
    ...
    "p39":  199,     # Guinness 0.44 can — по их счёту; в листе было 215
