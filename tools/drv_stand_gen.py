...
const ST_PROF = {month: '2026-09', name: 'Худоба', role: 'driver', role_t: 'Водитель', code: 'B1', district: 'jvc',
  ...
  items: [
    ...
    {id: 'auto:late_shift:2026-09-13', kind: 'fine', t: 'Штраф', amount: 40, per_month: 0, day: '2026-09-13', at: '', reason: 'Поздно открыл смену', note: 'открыл в 17:57, правило — до 15:00', text: 'Открытие смены позже 15:00 — смена открыта в 17:57', due: 0, left: 0, done: false, cancelled: false, auto: 'late_shift', forgiven: true, meal: true, meal_from: 80, meal_to: 40},
    ...
    {id: 'auto:late_shift:2026-09-12', kind: 'fine', t: 'Штраф', amount: 40, per_month: 0, day: '2026-09-12', at: '', reason: 'Поздно открыл смену', note: 'открыл в 16:20, правило — до 15:00', text: 'Открытие смены позже 15:00 — смена открыта в 16:20', due: 0, left: 0, done: false, cancelled: false, auto: 'late_shift', forgiven: false, meal: true, meal_from: 80, meal_to: 40},
