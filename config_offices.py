...
OFFICE_OPERATORS = {
    "office_central": [686932322, 1567466073, 625010022, 5103094517],   # Ambar — Центр
    "office_north":   [686932322, 1567466073, 625010022, 5103094517],   # Ambar — Север
    "office_south":   [686932322, 1567466073, 625010022, 5103094517],   # Ambar — Юг (same as central, change if needed)
}