...
# Тест-район (владелец, 17 сен 2026): отдельный район тест-водителя. В OFFICES
# и словарях выше его нет намеренно — по ним считаются выручка, склад, заявка,
# смены операторов и чек-лист, и по ним же клиентский заказ выбирает офис.
# Виден только в STAR («Кто на каком районе», «Телефоны водителей») и в
# приложении самого тест-водителя.
TEST_OFFICE = {"id": "test", "code": "T", "name": "Тест-район"}
