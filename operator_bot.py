...
PRODUCTS = [
    ...
    {"id":"p50", "name":"Bacardi Gold 1 ltr",          "price":100, "cat":"Ром"},
    {"id":"p51", "name":"Captain Morgan Black 1 ltr",  "price":150, "cat":"Ром"},
    {"id":"p52", "name":"Captain Morgan Gold 1 ltr",   "price":150, "cat":"Ром"},
    {"id":"p53", "name":"Malibu 1 ltr",                "price":150, "cat":"Ром"},
    # ── Вермут / Vermouth ─────────────────────────────────────────────────────
    {"id":"p54", "name":"Martini Bianco 1 ltr",        "price":100, "cat":"Вермут"},
    # ── Джин / Gin ────────────────────────────────────────────────────────────
    {"id":"p55", "name":"Gordon's 1 ltr",              "price":100, "cat":"Джин"},
    {"id":"p56", "name":"Bombay Sapphire 1 ltr",       "price":150, "cat":"Джин"},
    {"id":"p58", "name":"Gordon Pink 0.7 ltr",         "price":150, "cat":"Джин"},
    {"id":"p59", "name":"Tanqueray 1 ltr",             "price":200, "cat":"Джин"},
    {"id":"p57", "name":"Hendrick's 1 ltr",            "price":250, "cat":"Джин"},
    {"id":"p61", "name":"Malfy Con Arancia 0.7 ltr",   "price":250, "cat":"Джин"},
    {"id":"p62", "name":"Malfy Rosa 0.7 ltr",          "price":250, "cat":"Джин"},
    {"id":"p63", "name":"Drumshanbo Gunpowder 0.7 ltr","price":300, "cat":"Джин"},
    {"id":"p60", "name":"Monkey 47 0.5 ltr",           "price":350, "cat":"Джин"},
    # ── Текила / Tequila ──────────────────────────────────────────────────────
    {"id":"p64", "name":"Jose Cuervo Silver 1 ltr",    "price":100, "cat":"Текила"},
    {"id":"p65", "name":"Jose Cuervo Gold 1 ltr",      "price":100, "cat":"Текила"},
    {"id":"p66", "name":"Patron XO Cafe 0.75 ltr",     "price":250, "cat":"Текила"},
    {"id":"p67", "name":"Patron Silver 0.75 ltr",      "price":300, "cat":"Текила"},
    {"id":"p68", "name":"Patron Gold 0.75 ltr",        "price":350, "cat":"Текила"},
    {"id":"p69", "name":"Don Julio Blanco 70/75cl",    "price":350, "cat":"Текила"},
    {"id":"p70", "name":"Don Julio Reposado 70/75cl",  "price":400, "cat":"Текила"},
    {"id":"p71", "name":"Don Julio Anejo 70/75cl",     "price":550, "cat":"Текила"},
    {"id":"p72", "name":"Don Julio 1942 70/75cl",      "price":1500,"cat":"Текила"},
    {"id":"p73", "name":"Clase Azul Reposado 70/75cl", "price":1700,"cat":"Текила"},
    # ── Коньяк / Cognac ──────────────────────────────────────────────────────
    {"id":"p74", "name":"Hennessy VS 1 ltr",           "price":350, "cat":"Коньяк"},
    {"id":"p77", "name":"Remy Martin VSOP 1 ltr",      "price":400, "cat":"Коньяк"},
    {"id":"p75", "name":"Hennessy VSOP 1 ltr",         "price":450, "cat":"Коньяк"},
    {"id":"p76", "name":"Hennessy XO 1 ltr",           "price":1600,"cat":"Коньяк"},
    # ── Ликёр / Liqueur ──────────────────────────────────────────────────────
    {"id":"p78", "name":"Baileys 1 ltr",               "price":150, "cat":"Ликёр"},
    {"id":"p79", "name":"Amarula 1 ltr",               "price":150, "cat":"Ликёр"},
    {"id":"p81", "name":"Aperol 1 ltr",                "price":150, "cat":"Ликёр"},
    {"id":"p80", "name":"Jagermeister 1 ltr",          "price":200, "cat":"Ликёр"},
    {"id":"p82", "name":"Tequila Rose 0.7 ltr",        "price":200, "cat":"Ликёр"},
    # ── Арак / Arak ──────────────────────────────────────────────────────────
    {"id":"p83", "name":"Arak Touma 0.75 ltr",         "price":100, "cat":"Арак"},
    {"id":"p84", "name":"Efe Raki 1 ltr",              "price":150, "cat":"Арак"},
    # ── Шампанское / Champagne ────────────────────────────────────────────────
    {"id":"p85", "name":"Moet Brut 0.75",              "price":300, "cat":"Шампанское"},
    {"id":"p86", "name":"Moet Rose 0.75",              "price":400, "cat":"Шампанское"},
    {"id":"p88", "name":"Veuve Clicquot 0.75",         "price":450, "cat":"Шампанское"},
    {"id":"p87", "name":"Moet Ice 0.75",               "price":500, "cat":"Шампанское"},
    {"id":"p89", "name":"Ruinart Blanc 0.75",          "price":800, "cat":"Шампанское"},
    {"id":"p90", "name":"Dom Perignon 0.75",           "price":1500,"cat":"Шампанское"},
    # ── Просекко / Prosecco ───────────────────────────────────────────────────
    {"id":"p94", "name":"Martini Asti 0.75",           "price":100, "cat":"Просекко"},
    {"id":"p91", "name":"Bottega Prosecco 0.75",       "price":150, "cat":"Просекко"},
    {"id":"p95", "name":"Zonin Prosecco 0.75",         "price":150, "cat":"Просекко"},
    {"id":"p92", "name":"Bottega Rose 0.75",           "price":200, "cat":"Просекко"},
    {"id":"p93", "name":"Bottega Gold 0.75",           "price":250, "cat":"Просекко"},
    # ── Вино / Wine ───────────────────────────────────────────────────────────
    {"id":"p96",  "name":"Jacob Creek Chardonnay 0.75",    "price":100, "cat":"Вино"},
    {"id":"p97",  "name":"Pinot Grigio Cesari 0.75",      "price":100, "cat":"Вино"},
    {"id":"p98",  "name":"Le Grand Noir SB 0.75",         "price":100, "cat":"Вино"},
    {"id":"p105", "name":"Jacob Creek Shiraz 0.75",        "price":100, "cat":"Вино"},
    ...
    {"id":"p110", "name":"Campo Viejo Reserva 0.75",       "price":200, "cat":"Вино"},
    {"id":"p111", "name":"Chateau Des Laurets 0.75",       "price":200, "cat":"Вино"},
    {"id":"p116", "name":"Minuty Cotes De Provence 0.75",  "price":200, "cat":"Вино"},
    {"id":"p121", "name":"Drostdy Hof Grand Cru 5 ltr",   "price":200, "cat":"Вино"},
    {"id":"p122", "name":"Drostdy Hof Claret 5 ltr",      "price":200, "cat":"Вино"},
    {"id":"p101", "name":"Louis Moreau Chablis 0.75",      "price":250, "cat":"Вино"},
    {"id":"p102", "name":"Bourgogne Louis Jadot 0.75",     "price":250, "cat":"Вино"},
    {"id":"p103", "name":"Gavi Di Gavi 0.75",              "price":250, "cat":"Вино"},
    {"id":"p113", "name":"Campo Viejo Gran Reserva 0.75",  "price":250, "cat":"Вино"},
    {"id":"p118", "name":"Whispering Angel 0.75",          "price":250, "cat":"Вино"},
    {"id":"p119", "name":"Saint Maur Rose 0.75",           "price":250, "cat":"Вино"},
    {"id":"p114", "name":"Chateau Lagrange 0.75",          "price":800, "cat":"Вино"},
]
