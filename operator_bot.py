...
PRODUCTS = [
    ...
    {"id":"p12", "name":"Jack Daniels 1 ltr",          "price":210, "cat":"Виски"},
    ...
    # ── Ром / Rum ─────────────────────────────────────────────────────────────
    {"id":"p47", "name":"Bacardi White 1 ltr",         "price":120, "cat":"Ром"},
    {"id":"p48", "name":"Bacardi Black 1 ltr",         "price":130, "cat":"Ром"},
    {"id":"p49", "name":"Bacardi Gold 1 ltr",          "price":150, "cat":"Ром"},
    {"id":"p50", "name":"Captain Morgan Black 1 ltr",  "price":160, "cat":"Ром"},
    {"id":"p51", "name":"Captain Morgan Gold 1 ltr",   "price":160, "cat":"Ром"},
    {"id":"p52", "name":"Malibu 1 ltr",                "price":170, "cat":"Ром"},
    # ── Вермут / Vermouth ─────────────────────────────────────────────────────
    {"id":"p53", "name":"Martini Bianco 1 ltr",        "price":130, "cat":"Вермут"},
    # ── Джин / Gin ────────────────────────────────────────────────────────────
    {"id":"p54", "name":"Gordon's 1 ltr",              "price":120, "cat":"Джин"},
    {"id":"p55", "name":"Bombay Sapphire 1 ltr",       "price":170, "cat":"Джин"},
    {"id":"p57", "name":"Gordon Pink 0.7 ltr",         "price":160, "cat":"Джин"},
    {"id":"p58", "name":"Tanqueray 1 ltr",             "price":210, "cat":"Джин"},
    {"id":"p56", "name":"Hendrick's 1 ltr",            "price":270, "cat":"Джин"},
    {"id":"p60", "name":"Malfy Con Arancia 0.7 ltr",   "price":270, "cat":"Джин"},
    {"id":"p61", "name":"Malfy Rosa 0.7 ltr",          "price":270, "cat":"Джин"},
    {"id":"p62", "name":"Drumshanbo Gunpowder 0.7 ltr","price":310, "cat":"Джин"},
    {"id":"p59", "name":"Monkey 47 0.5 ltr",           "price":360, "cat":"Джин"},
    # ── Текила / Tequila ──────────────────────────────────────────────────────
    {"id":"p63", "name":"Jose Cuervo Silver 1 ltr",    "price":130, "cat":"Текила"},
    {"id":"p64", "name":"Jose Cuervo Gold 1 ltr",      "price":150, "cat":"Текила"},
    {"id":"p65", "name":"Patron XO Cafe 0.75 ltr",     "price":260, "cat":"Текила"},
    {"id":"p66", "name":"Patron Silver 0.75 ltr",      "price":370, "cat":"Текила"},
    {"id":"p67", "name":"Patron Gold 0.75 ltr",        "price":550, "cat":"Текила"},
    {"id":"p68", "name":"Don Julio Blanco 70/75cl",    "price":370, "cat":"Текила"},
    {"id":"p69", "name":"Don Julio Reposado 70/75cl",  "price":500, "cat":"Текила"},
    {"id":"p70", "name":"Don Julio Anejo 70/75cl",     "price":560, "cat":"Текила"},
    {"id":"p71", "name":"Don Julio 1942 70/75cl",      "price":1750,"cat":"Текила"},
    {"id":"p72", "name":"Clase Azul Reposado 70/75cl", "price":1730,"cat":"Текила"},
    # ── Коньяк / Cognac ──────────────────────────────────────────────────────
    {"id":"p73", "name":"Hennessy VS 1 ltr",           "price":400, "cat":"Коньяк"},
    {"id":"p76", "name":"Remy Martin VSOP 1 ltr",      "price":430, "cat":"Коньяк"},
    {"id":"p74", "name":"Hennessy VSOP 1 ltr",         "price":550, "cat":"Коньяк"},
    {"id":"p75", "name":"Hennessy XO 1 ltr",           "price":1630,"cat":"Коньяк"},
    # ── Ликёр / Liqueur ──────────────────────────────────────────────────────
    {"id":"p77", "name":"Baileys 1 ltr",               "price":170, "cat":"Ликёр"},
    {"id":"p78", "name":"Amarula 1 ltr",               "price":160, "cat":"Ликёр"},
    {"id":"p80", "name":"Aperol 1 ltr",                "price":160, "cat":"Ликёр"},
    {"id":"p79", "name":"Jagermeister 1 ltr",          "price":210, "cat":"Ликёр"},
    {"id":"p81", "name":"Tequila Rose 0.7 ltr",        "price":210, "cat":"Ликёр"},
    # ── Арак / Arak ──────────────────────────────────────────────────────────
    {"id":"p82", "name":"Arak Touma 0.75 ltr",         "price":120, "cat":"Арак"},
    {"id":"p83", "name":"Efe Raki 1 ltr",              "price":160, "cat":"Арак"},
    # ── Шампанское / Champagne ────────────────────────────────────────────────
    {"id":"p84", "name":"Moet Brut 0.75",              "price":330, "cat":"Шампанское"},
    {"id":"p85", "name":"Moet Rose 0.75",              "price":430, "cat":"Шампанское"},
    {"id":"p87", "name":"Veuve Clicquot 0.75",         "price":460, "cat":"Шампанское"},
    {"id":"p86", "name":"Moet Ice 0.75",               "price":530, "cat":"Шампанское"},
    {"id":"p88", "name":"Ruinart Blanc 0.75",          "price":820, "cat":"Шампанское"},
    {"id":"p89", "name":"Dom Perignon 0.75",           "price":1750,"cat":"Шампанское"},
    # ── Просекко / Prosecco ───────────────────────────────────────────────────
    {"id":"p93", "name":"Martini Asti 0.75",           "price":150, "cat":"Просекко"},
    {"id":"p90", "name":"Bottega Prosecco 0.75",       "price":160, "cat":"Просекко"},
    {"id":"p94", "name":"Zonin Prosecco 0.75",         "price":160, "cat":"Просекко"},
    {"id":"p91", "name":"Bottega Rose 0.75",           "price":220, "cat":"Просекко"},
    {"id":"p92", "name":"Bottega Gold 0.75",           "price":260, "cat":"Просекко"},
    # ── Вино / Wine ───────────────────────────────────────────────────────────
    {"id":"p95",  "name":"Jacob Creek Chardonnay 0.75",    "price":120, "cat":"Вино"},
    {"id":"p96",  "name":"Pinot Grigio Cesari 0.75",      "price":120, "cat":"Вино"},
    {"id":"p97",  "name":"Le Grand Noir SB 0.75",         "price":130, "cat":"Вино"},
    {"id":"p104", "name":"Jacob Creek Shiraz 0.75",        "price":120, "cat":"Вино"},
    {"id":"p105", "name":"Le Grand Noir Merlot 0.75",     "price":120, "cat":"Вино"},
    {"id":"p114", "name":"Mateus Rose 0.75",               "price":120, "cat":"Вино"},
    {"id":"p116", "name":"Chateau Ksara Rose 0.75",        "price":120, "cat":"Вино"},
    {"id":"p99",  "name":"Calvet Sancerre 0.75",          "price":160, "cat":"Вино"},
    {"id":"p108", "name":"Chateau Saint Leon 0.75",        "price":160, "cat":"Вино"},
    {"id":"p111", "name":"La Celia Malbec 0.75",           "price":160, "cat":"Вино"},
    {"id":"p119", "name":"MiP Collection Rose 0.75",       "price":160, "cat":"Вино"},
    {"id":"p98",  "name":"Rimapere SB 0.75",              "price":220, "cat":"Вино"},
    {"id":"p103", "name":"Oyster Bay SB 0.75",             "price":220, "cat":"Вино"},
    {"id":"p106", "name":"Castel Barreyres 0.75",          "price":220, "cat":"Вино"},
    {"id":"p107", "name":"Chateau Perron 0.75",            "price":220, "cat":"Вино"},
    {"id":"p109", "name":"Campo Viejo Reserva 0.75",       "price":220, "cat":"Вино"},
    {"id":"p110", "name":"Chateau Des Laurets 0.75",       "price":220, "cat":"Вино"},
    {"id":"p115", "name":"Minuty Cotes De Provence 0.75",  "price":220, "cat":"Вино"},
    {"id":"p120", "name":"Drostdy Hof Grand Cru 5 ltr",   "price":220, "cat":"Вино"},
    {"id":"p121", "name":"Drostdy Hof Claret 5 ltr",      "price":220, "cat":"Вино"},
    {"id":"p100", "name":"Louis Moreau Chablis 0.75",      "price":260, "cat":"Вино"},
    {"id":"p101", "name":"Bourgogne Louis Jadot 0.75",     "price":260, "cat":"Вино"},
    {"id":"p102", "name":"Gavi Di Gavi 0.75",              "price":260, "cat":"Вино"},
    {"id":"p112", "name":"Campo Viejo Gran Reserva 0.75",  "price":260, "cat":"Вино"},
    {"id":"p117", "name":"Whispering Angel 0.75",          "price":260, "cat":"Вино"},
    {"id":"p118", "name":"Saint Maur Rose 0.75",           "price":260, "cat":"Вино"},
    {"id":"p113", "name":"Chateau Lagrange 0.75",          "price":820, "cat":"Вино"},
]
