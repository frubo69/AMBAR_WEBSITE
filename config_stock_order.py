...
121 позиция совпала один в один. Не совпали двое — в таблице есть
«JC CHARDONNAY PINOT NOIR», которого нет в каталоге, а в каталоге есть
Ballantines Finest, которого нет в таблице; он и стоит последним.
"""
...
STOCK_ORDER = [
    ...
    "p96",     #  18 Jacob Creek Chardonnay 0.75  # JC CHARDONNAY 75CL
    ...
    "p91",     #  74 Bottega Prosecco 0.75  # BOTTEGA VINO D POET PROS
    "p92",     #  75 Bottega Rose 0.75  # BOTTEGA ROSE Proseco POE
    "p93",     #  76 Bottega Gold 0.75  # BOTTEGA GOLD BRUT 75C vi
    "p88",     #  77 Veuve Clicquot 0.75  # VEUVE CLICQUOT Y/L PONSR
    "p85",     #  78 Moet Brut 0.75  # MOET & CHANDON BRUT IMP
    "p86",     #  79 Moet Rose 0.75  # MOET & CHANDON  ROSE 75CL
    "p87",     #  80 Moet Ice 0.75  # MOET ICE IMPERIAL 75cl
    "p90",     #  81 Dom Perignon 0.75  # DOM PERIGNON M&C 75CL
    "p25",     #  82 Glenfiddich 12Y 1 ltr  # GLENDFIDICH SPL R12YRS
    "p26",     #  83 Glenfiddich 15Y 1 ltr  # GLENDFIDICH 15 YRS LTR
    "p27",     #  84 Glenfiddich 18Y 0.75 ltr  # GLENDFIDICH 18Y Smal Bat
    "p99",     #  85 Rimapere Sauvignon Blanc 0.75  # BARON RIMAPERE SAUV BLAN
    "p103",    #  86 Gavi Di Gavi 0.75  # MARCHESI GAVI D GAVI 75C
    "p101",    #  87 Louis Moreau Chablis 0.75  # LAROCHE CHABLIS ST MARTI
    "p102",    #  88 Bourgogne Louis Jadot 0.75  # L J BOURGOGNE BL Cuv D ja
    "p107",    #  89 Castel Barreyres 0.75  # CASTEL CH. BARREYRES HAUT M 75
    "p109",    #  90 Chateau Saint Leon 0.75  # CH SAINT LEON BOX SUP 75
    "p110",    #  91 Campo Viejo Reserva 0.75  # CAMPO VIEJO RESERVA RIOJ
    "p113",    #  92 Campo Viejo Gran Reserva 0.75  # CAMPO VIEJO GRAN RESERVA
    "p116",    #  93 Minuty Cotes De Provence 0.75  # M MINUTY ROSE PROVENCE
    "p118",    #  94 Whispering Angel 0.75  # Cav D ESCLN WHISPERING
    "p19",     #  95 Jack Daniels Honey 1 ltr  # JACK DANIELS HONEY LTR
    "p46",     #  96 Bacardi Breezer Melon 0.275 bottle  # BACCARDI BREEZER W/MELON
    "p41",     #  97 Asahi Super Dry 0.33 bottle  # ASAHI BEER BTLS SUPER DR
    "p81",     #  98 Aperol 1 ltr  # APEROLE Aperitivo LTR
    "p24",     #  99 Chivas Regal 25Y 0.7 ltr  # CHIVAS 25 YRS
    "p73",     # 100 Clase Azul Reposado 70/75cl  # CLASE AZUL Reposado 70/7
    "p108",    # 101 Chateau Perron 0.75  # MS CH PERRON LALANDE D POMEROL
    "p112",    # 102 La Celia Malbec 0.75  # LA CELIA RESERVA MALBEC 75CL
    "p100",    # 103 Calvet Sancerre 0.75  # CALVET SANCERRE Les Hautes
    "p111",    # 104 Chateau Des Laurets 0.75  # CHATEAU des LAURETS Saint Emilion
    "p39",     # 105 Guinness 0.44 can  # GUINNESS BEER CANS 44cl
    "p40",     # 106 XXL Vodka 0.25 can  # XXL  VODKA MIX ENERGY CAN
    "p60",     # 107 Monkey 47 0.5 ltr  # MONKEY 47  DRY GIN 50CL
    "p20",     # 108 Gentleman Jack 1 ltr  # GENTLEMAN JACK 1 LTR JD
    "p28",     # 109 Macallan 12Y 0.7 ltr  # MACALLAN 12 YR FIN TRIP
    "p29",     # 110 Macallan 15Y 0.7 ltr  # MACALLAN 15 YRS Double Ca
    "p30",     # 111 Macallan 18Y 0.75 ltr  # MACALLAN 18 YRS
    "p42",     # 112 Hoegaarden 0.33 bottle  # HOEGARDEN BLANCHE 33CL B
    "p82",     # 113 Tequila Rose Strawberry Cream 0.7 ltr  # TEQUILA ROSE LIQUER 70C S/Bery
    "p61",     # 114 Malfy Con Arancia 0.7 ltr  # MALFY Con Ara Blood Orange GIN 70
    "p62",     # 115 Malfy Rosa 0.7 ltr  # MALFY GIN ROSA 70cl GrapfruitE
    "p63",     # 116 Drumshanbo Gunpowder 0.7 ltr  # Drumshanb GUNPODER GIN
    "p119",    # 117 Saint Maur Rose 0.75  # CH SAINT MAUR L Exelenc ROS 7
    "p114",    # 118 Chateau Lagrange 0.75  # CH LAGRANGE 2010 St Julien
    "p89",     # 119 Ruinart Blanc 0.75  # RUINART BLANC D BLANC 75 CL
    "p95",     # 120 Zonin Prosecco 0.75  # ZONIN PROSECCO 75CL
    "p104",    # 121 Oyster Bay Sauvignon Blanc 0.75  # OYSTER BAY SAUVIGNON
    "p15",     # 122 Ballantines Finest 1 ltr
]
