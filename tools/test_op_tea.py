...
настоящие db, op_tea и ручка /api/operator/tea:
  ...
  • сегодня: сумма, разбивка по районам, «в работе» — ещё не доставленные;
...
async def main():
    ...
    await d.orders.insert_many([
        ...
        order("A1", TODAY, "jvc", [(WINE, "Oyster Bay", 2), (VODKA, "Absolut", 3)], driver="Худоба"),
    ...
    eq("заказ строкой: район, водитель и за какие бутылки", (a1["code"], a1["driver"], a1["lines"], a1["bottles"]),
       ("B1", "Худоба", [{"name": "Oyster Bay", "qty": 2, "aed": 100}], 2))
